...
import FAQ from "./FAQ";
import FeaturedVenueList from "./FeaturedVenueList";
const Hero = () => {
  return (
    <>
      {/* HERO SECTION */}
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto">
          <div className="flex flex-wrap p-5 items-center">
            ...
            <div className="lg:w-2/12 mt-10 ">
              <div className="hero__img-box mr-1 ml-1">
                <img
            ...
            <div className="flex flex-col justify-between gap-8 items-start lg:items-end">
              <div className="rounded-lg overflow-hidden">
                <img
                  ...
                  alt=""
                  className="w-full pr-20 rounded"
                />
              </div>
            </div>
          </div>

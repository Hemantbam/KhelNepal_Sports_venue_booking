...
const TermsModal = () => {
    ...
    return (
        <>
        <Navbar/>
            <div className="p-4 pb-2 md:p-5 space-y-4 overflow-y-scroll w-10/12 m-auto text-justify ">
                <h2 className="text-3xl font-semibold text-gray-900 mb-4 mt-20">Terms and Conditions</h2>
                <hr />
                {/* Welcome Section */}
                <section>

...
export default function SingleVenue() {
  ...
  return (
    <>
      <Navbar />
      <section className="text-gray-300 bg-gray-100 body-font overflow-hidden">
        <div className="px-5 py-24 mx-auto">
          <div className="mx-auto flex flex-wrap bg-white rounded-lg shadow-md overflow-hidden">
            <img
              alt={venue.name}
            ...
            <div className="lg:px-10 md:px-4 sm:px-2 px-2 py-5 text-start max-w-screen-md ">
          ...
          <div class="flex text-gray-800 mx-auto container px-5 lg:px-10 md:px-4 sm:px-2 py-5">
            <div class="flex flex-wrap w-full lg:flex-nowrap">
              <div class="w-full lg:w-2/3 px-5 lg:mr-5 mb-5 lg:mb-0">
                <div class="py-10 bg-white rounded-lg p-4 shadow-md">
                  <h3 class="text-xl font-bold mb-3 ">Reviews</h3>
                  <Review id={venue._id} />
                  <hr class="border-gray-100 border-2 w-full" />
                  <Comment userID={venue.managedBy} venueID={venue._id} />
                </div>
              </div>
              <div class="w-full lg:w-1/3">
                <div class="px-5 py-10 bg-white rounded-lg shadow-md">
                  <Recent />
                  <hr class="border-gray-100 border-2 my 2 w-full" />
